 ...
 */
public class Restaurants_near_LocationAsyncTask extends AsyncTask<HashMap<String,String>, Void, String> {
    ...
    public Restaurants_near_LocationAsyncTask(Context context){
    ...
    protected void onPreExecute() {
        ...
        mProgress.setMessage("Fetching nearby places");
    ...
    protected String doInBackground(HashMap<String, String>... params) {
        ...
        try {
            ...
            URL url = new URL("https://developers.zomato.com/api/v2.1/location_details?" + params_formed);
...
//            httpConnection.setRequestProperty( "Content-Length", Integer.toString( postDataLength ));
    ...
    protected void onPostExecute(String response) {
        ...
        HashMap entity_values = json_parser.parse_nearby(response);
        System.out.println(">> hashmap size is "+ entity_values.size());
        delegate.processFinish4(entity_values);
